...
def time_delta(t1, t2):
    dayName1, day1, month1, year1, time1, diff1 = t1.split()
    dayName2, day2, month2, year2, time2, diff2 = t2.split()
    
    diffHour1 = int(diff1[:-2])
    diffMin1 = int(diff1[-2:])
    diffHour2 = int(diff2[:-2])
    diffMin2 = int(diff2[-2:])
    
    return (diffHour2 - diffHour1) * 3600 + (diffMin2 - diffMin1) * 60
